...
begin
	...
	payoff_plot = plot(
		...
		legend=:topright,
		lw=2,
		ylim=(1.0, optimal_average_payoff+0.001)
	)
...
begin
	...
	vline!([optimal_delta], label="optimal degree of pessimism")
	annotate!(6, 0.2, "only payoff bias")
	...
	vline!([optimal_delta], label="optimal degree of pessimism")
	annotate!(6, 0.002, "with conformity")
