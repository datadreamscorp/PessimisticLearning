...
begin
	...
	savefig(varplot, "../images/fig2_var.pdf")
	varplot
end
...
begin
	...
	savefig(indv_plot, "../images/fig4_indv.pdf")
...
begin
	...
	savefig(sens_plot, "../images/fig5_sensitivity.pdf")
	sens_plot
end
...
begin
	...
	savefig(dev_plot, "../images/fig6_development.pdf")
	dev_plot
end
...
begin
	...
	savefig(aleph_plotter, "../images/fig7_aleph.pdf")
...
begin
	...
	savefig(full_conservative_plot, "../images/fig8_payoffs_attitudes.pdf")
...
begin
	...
	savefig(abmplot, "../images/fig9_time.pdf")
...
begin
	inequality_plot = plot(
		plot(
			plot(stab_plot_low(mshift=6.0, n=25, eshift=10, freq=0.75, leg=false),  leg=:bottomleft, title=L"f = 0.25"),
			
			plot(stab_plot_low(mshift=6.0, n=25, eshift=10, freq=0.5, leg=false), ylab="", title=L"f = 0.5"),

			plot(stab_plot_low(mshift=6.0, n=25, eshift=10, freq=0.25), ylab="", title=L"f = 0.75", leg=false),
			layout=(1,3), xlab=""
		),
		plot(
			stab_plot_low(mshift=6.0, n=25, eshift=5, freq=0.75, leg=false),
			
			plot(stab_plot_low(mshift=6.0, n=25, eshift=5, freq=0.5, leg=false), ylabel=""),

			plot(stab_plot_low(mshift=6.0, n=25, eshift=5, freq=0.25, leg=false), ylabel=""),
			
			layout=(1,3),
			xlabel=""
		),
		plot(
			plot(stab_plot_low(mshift=6.0, n=25, eshift=2, freq=0.75, leg=false), xlab=""),
			
			plot(stab_plot_low(mshift=6.0, n=25, eshift=2, freq=0.5, leg=false), ylabel=""),

			plot(stab_plot_low(mshift=6.0, n=25, eshift=2, freq=0.25, leg=false), ylabel="", xlab=""),
	...
	savefig(inequality_plot, "../images/fig10_inequality.pdf")
...
begin
	...
	savefig(total_poverty, "../images/fig11_learningstyles.pdf")
...
begin
	aleph_geo_plotter = plot(
		plot(
			aleph_geo_plot(2.0, 2, ylab=L"\bar{V}_G \quad | \quad \kappa_G = 2", title=L"λ = "*"2.0"),
		...
		plot(
			aleph_geo_plot(2.0, 5, ylab=L"\bar{V}_G \quad | \quad \kappa_G = 5"),
		...
		plot(
			aleph_geo_plot(2.0, 10, ylab=L"\bar{V}_G \quad | \quad \kappa_G = 10", xlab="wealth buffer "*L"(ℵ)", legend=true),
